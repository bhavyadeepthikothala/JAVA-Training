...
import com.tekeztrain.spring.web.Login;
...
public class RegistrationController 
{
	...
	public ModelAndView processRegistration(@Valid @ModelAttribute Student student, Model model, Errors errors)
	{
		...
		System.out.println(student.toString());
		return new ModelAndView("login", "message", "You have successfully registered. Please Login now!!!");
	}
	
	@RequestMapping(value="/processLogin", method = RequestMethod.POST)
	
	public ModelAndView processLogin(@Valid @ModelAttribute Login login, Model model, Errors errors)
	{
		if(errors.hasErrors())
		{
